    ...
    <transition name="fade">
     ...
     <transition name="content">
      <div class="personal-content1"  v-show="isShow1">
        <div class="t-order-examine-header">创建优惠券</div>
        <div class="t-order-examine-content">
          ...
          <el-form-item label="优惠券模板：" prop="price">
            <el-select size="medium" style="margin:0;width:200px;" placeholder="选择模板">
                <!-- <el-option
          ...
          <el-form-item label="优惠券数量：" prop="price">
            <el-input class="w-200" placeholder="填写数量" size="small" v-model="content.price"></el-input>
          </el-form-item>
          </el-form>
        </div>
