// 一级行业
const OneLndustry = [
        {'id':'10100','title':'IT|通信|电子|互联网'},
        {'id':'10200','title':'金融业'},
        {'id':'10800','title':'房地产|建筑业'},
        {'id':'10900','title':'商业服务'},
        {'id':'10300','title':'贸易|批发|零售|租赁业'},
        {'id':'10400','title':'文体教育|工艺美术'},
        {'id':'10500','title':'生产|加工|制造'},
        {'id':'11500','title':'交通|运输|物流|仓储'},
        {'id':'10000','title':'服务业'},
        {'id':'11300','title':'文化|传媒|娱乐|体育'},
        {'id':'11600','title':'能源|矿产|环保'},
        {'id':'11100','title':'政府|非盈利机构'},
        {'id':'11400','title':'农|林|牧|渔|其他'}
        ];
// 二级行业
const TowLndustry=[
        {id: "210500", pid: "10100", title: "互联网/电子商务"},
        {id: "160400", pid: "10100", title: "计算机软件"},
        {id: "160000", pid: "10100", title: "IT服务(系统/数据/维护)"},
        {id: "160500", pid: "10100", title: "电子技术/半导体/集成电路"},
        {id: "160200", pid: "10100", title: "计算机硬件"},
        {id: "300100", pid: "10100", title: "通信/电信/网络设备"},
        {id: "160100", pid: "10100", title: "通信/电信运营、增值服务"},
        {id: "160600", pid: "10100", title: "网络游戏"},
        {id: "180000", pid: "10200", title: "基金/证券/期货/投资"},
        {id: "180100", pid: "10200", title: "保险"},
        {id: "300500", pid: "10200", title: "银行"},
        {id: "300900", pid: "10200", title: "信托/担保/拍卖/典当"},
        {id: "140000", pid: "10800", title: "房地产/建筑/建材/工程"},
        {id: "140100", pid: "10800", title: "家居/室内设计/装饰装潢"},
        {id: "140200", pid: "10800", title: "物业管理/商业中心"},
        {id: "200300", pid: "10900", title: "专业服务/咨询(财会/法律/人力资源等)"},
        {id: "200302", pid: "10900", title: "广告/会展/公关"},
        {id: "201400", pid: "10900", title: "中介服务"},
        {id: "201300", pid: "10900", title: "检验/检测/认证"},
        {id: "300300", pid: "10900", title: "外包服务"},
        {id: "120400", pid: "10300", title: "快速消费品（食品/饮料/烟酒/日化）"},
        {id: "120200", pid: "10300", title: "耐用消费品（服饰/纺织/皮革/家具/家电）"},
        {id: "170500", pid: "10300", title: "贸易/进出口"},
        {id: "170000", pid: "10300", title: "零售/批发"},
        {id: "300700", pid: "10300", title: "租赁服务"},
        {id: "201100", pid: "10400", title: "教育/培训/院校"},
        {id: "120800", pid: "10400", title: "礼品/玩具/工艺美术/收藏品/奢侈品"},
        {id: "121000", pid: "10500", title: "汽车/摩托车"},
        {id: "129900", pid: "10500", title: "大型设备/机电设备/重工业"},
        {id: "121100", pid: "10500", title: "加工制造（原料加工/模具）"},
        {id: "121200", pid: "10500", title: "仪器仪表及工业自动化"},
        {id: "210600", pid: "10500", title: "印刷/包装/造纸"},
        {id: "120700", pid: "10500", title: "办公用品及设备"},
        {id: "121300", pid: "10500", title: "医药/生物工程"},
        {id: "121500", pid: "10500", title: "医疗设备/器械"},
        {id: "300000", pid: "10500", title: "航空/航天研究与制造"},
        {id: "150000", pid: "11500", title: "交通/运输"},
        {id: "301100", pid: "11500", title: "物流/仓储"},
        {id: "121400", pid: "10000", title: "医疗/护理/美容/保健/卫生服务"},
        {id: "200600", pid: "10000", title: "酒店/餐饮"},
        {id: "200800", pid: "10000", title: "旅游/度假"},
        {id: "210300", pid: "11300", title: "媒体/出版/影视/文化传播"},
        {id: "200700", pid: "11300", title: "娱乐/体育/休闲"},
        {id: "130000", pid: "11600", title: "能源/矿产/采掘/冶炼"},
        {id: "120500", pid: "11600", title: "石油/石化/化工"},
        {id: "130100", pid: "11600", title: "电气/电力/水利"},
        {id: "201200", pid: "11600", title: "环保"},
        {id: "200100", pid: "11100", title: "政府/公共事业/非盈利机构"},
        {id: "120600", pid: "11100", title: "学术/科研"},
        {id: "100000", pid: "11400", title: "农/林/牧/渔"},
        {id: "100100", pid: "11400", title: "跨领域经营"},
        {id: "990000", pid: "11400", title: "其他"}
    ];
...
function province(province) {
	var rte;
  	this.province1.forEach(function(res){
  		if (res.ProID==province) {
			rte = res.ProName
		}
  	})
  	return rte
...
function city (city) {
	var rte;
  	this.city1.forEach(function(res){
  		if (res.CityID==city) {
  			rte = res.CityName
		}
  	})
...
function county (county) {
	var rte;
  	this.county1.forEach(function(res){
  		if (res.Id==county) {
  			rte = res.countyName
		}
  	})
...
export default{
	province1,city1,county1,province,city,county,OneLndustry,TowLndustry
}