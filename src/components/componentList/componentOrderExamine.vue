    ...
    <transition name="fade">
     ...
     <transition name="content">
      <div class="personal-content1"  v-show="isShow1">
        <div class="t-order-examine-header">接受委托</div>
        <div class="t-order-examine-content">
          ...
          <el-form-item label="服务收费：" prop="price">
            <el-input class="w-200" size="small" v-model="content.price"></el-input>
          </el-form-item>
          <el-form-item label="快递收费：" prop="expressFee">
            <el-input class="w-200" size="small" v-model="content.expressFee"></el-input>
          </el-form-item>
          <el-form-item label="办理周期：" prop="duratiion">
            <el-input class="w-200" size="small" v-model="content.duratiion"></el-input>
          </el-form-item>
          </el-form>
        </div>
          <div class="t-order-confirm">
            <div class="t-right">
              ...
              <el-button size="small" @click="ok('content')" type="primary">确 认</el-button>
            </div>
          </div>
      </div>
    </transition>
