...
<div>
	...
	<el-breadcrumb separator="/">
		  ...
		  <el-breadcrumb-item v-if="index1==1">委托类订单管理</el-breadcrumb-item>
		  <el-breadcrumb-item v-if="index1==4">课程类订单管理</el-breadcrumb-item>
		</el-breadcrumb>
		<div class="t-zqHome-title" style="margin-bottom:20px;" v-if="index1==1">委托类订单管理</div>
		<div class="t-zqHome-title" style="margin-bottom:20px;" v-if="index1==4">课程类订单管理</div>
		<div class="t-zqHome-server" @click="switchCategory(1)"  :class="index1==1?'t-zqHome-server-Selected':''">
			委托类订单管理
		</div>
		<div class="t-zqHome-server" @click="switchCategory(4)"  :class="index1==4?'t-zqHome-server-Selected':''">
			课程类订单管理
		</div>
	</div>
