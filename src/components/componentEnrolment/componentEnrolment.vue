<template>
<div>
	<div class="t-zqHome-navigation" style="height:280px;">
	<el-breadcrumb separator="/">
	  <el-breadcrumb-item :to="{ path: content.upper }">订单管理</el-breadcrumb-item>
	  <el-breadcrumb-item>报名管理</el-breadcrumb-item>
	</el-breadcrumb>
	<div class="t-zqHome-title">报名管理</div>
	<div>
	 <el-select size="small" v-model="first" placeholder="一级类目" @change="first1"
	  style="margin-top:24px;width:450px;">
    <el-option
  ...
  <div>
	<el-select size="small" v-model="second" @change="second1" placeholder="二级类目" style="margin-top:24px;width:450px;">
    <el-option
  ...
  <div>
	 <el-select size="small" v-model="Train" @change="Train1" placeholder="课程" style="margin-top:24px;width:450px;">
    <el-option
	...
	<div class="t-server-content">
		<div class="t-zqHome-list-content">
			<div>
				<div class="t-left t-order-list-title">报名列表</div>
				<div class="t-right">
	...
	<ComponentEnrolmentDetails @changeIsShow="changeIsShow" :content='content' :isShow="isShow"></ComponentEnrolmentDetails>
</div>
...
import componentEnrolmentDetails from './componentEnrolmentDetails'
export default {
  data () {
    return {
    	content2:{ // 导航配置
    ...
    components: {
    	...
    	ComponentEnrolmentDetails: componentEnrolmentDetails
    },
    watch: {
