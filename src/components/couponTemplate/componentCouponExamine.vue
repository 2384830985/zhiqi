    ...
    <transition name="fade">
     ...
     <transition name="content">
      <div class="personal-content1"  v-show="isShow1">
        <div class="t-order-examine-header">发放优惠券</div>
        <div class="t-order-examine-content">
          ...
          <el-form-item label="用户账号：" prop="price">
            <el-input class="w-200" placeholder="填写账号" size="small" v-model="content.price"></el-input>
          </el-form-item>
          <el-form-item label="用户企业：" prop="price">
            <el-select size="medium" style="margin:0;width:200px;" placeholder="请选择用户企业">
                <!-- <el-option
          ...
          <div class="t-order-confirm">
            <div class="t-right">
              ...
              <el-button size="small" @click="ok('content')" type="primary">立即发放</el-button>
            </div>
          </div>
      </div>
    </transition>
